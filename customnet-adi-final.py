...
weightsnew = {
    ...
    'wc3': tf.Variable(tf.random_normal([3, 3, 20, 40])),
    'wc4': tf.Variable(tf.random_normal([5, 5, 40, 60])),
    'wd1': tf.Variable(tf.random_normal([32*32*60, 1024])),
...
biasesnew = {
    ...
    'bc3': tf.Variable(tf.random_normal([40])),
